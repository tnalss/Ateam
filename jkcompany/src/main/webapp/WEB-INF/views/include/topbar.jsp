...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">hanul_jk@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>062-362-7798</span></i>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
    	<a href="<c:url value='/'/>"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
      </div>
